...
/*
 * S64A compatibility defaults for OpenHarmony LiteOS-M port.
 * Final product board:
 * - SC2336 MIPI CSI
 * - SCCB/I2C shared bus GPIO8(SCL) / GPIO7(SDA)
 * - RGB565 display path
 */
#ifndef CONFIG_EXAMPLE_ENABLE_MIPI_CSI_CAM_SENSOR
#define CONFIG_EXAMPLE_ENABLE_MIPI_CSI_CAM_SENSOR 1
#endif

#ifndef CONFIG_EXAMPLE_MIPI_CSI_SCCB_I2C_PORT
#define CONFIG_EXAMPLE_MIPI_CSI_SCCB_I2C_PORT 0
#endif

#ifndef CONFIG_EXAMPLE_MIPI_CSI_SCCB_I2C_SCL_PIN
#define CONFIG_EXAMPLE_MIPI_CSI_SCCB_I2C_SCL_PIN 8
#endif

#ifndef CONFIG_EXAMPLE_MIPI_CSI_SCCB_I2C_SDA_PIN
#define CONFIG_EXAMPLE_MIPI_CSI_SCCB_I2C_SDA_PIN 7
#endif

#ifndef CONFIG_EXAMPLE_MIPI_CSI_SCCB_I2C_FREQ
#define CONFIG_EXAMPLE_MIPI_CSI_SCCB_I2C_FREQ 100000
#endif

#ifndef CONFIG_EXAMPLE_MIPI_CSI_CAM_SENSOR_RESET_PIN
#define CONFIG_EXAMPLE_MIPI_CSI_CAM_SENSOR_RESET_PIN -1
#endif

#ifndef CONFIG_EXAMPLE_MIPI_CSI_CAM_SENSOR_PWDN_PIN
#define CONFIG_EXAMPLE_MIPI_CSI_CAM_SENSOR_PWDN_PIN -1
#endif

#ifndef CONFIG_EXAMPLE_ENABLE_CAM_SENSOR_PIC_VFLIP
#define CONFIG_EXAMPLE_ENABLE_CAM_SENSOR_PIC_VFLIP 0
#endif

#ifndef CONFIG_EXAMPLE_ENABLE_CAM_SENSOR_PIC_HFLIP
#define CONFIG_EXAMPLE_ENABLE_CAM_SENSOR_PIC_HFLIP 0
#endif

#ifndef CONFIG_EXAMPLE_CAM_BUF_COUNT
#define CONFIG_EXAMPLE_CAM_BUF_COUNT 3
#endif
...
#ifndef CONFIG_LCD_PIXEL_FORMAT_RGB888
#define CONFIG_LCD_PIXEL_FORMAT_RGB888 0
#endif
...
typedef enum {
    OSPTEK_VIDEO_FMT_RAW8 = V4L2_PIX_FMT_SBGGR8,
    OSPTEK_VIDEO_FMT_RAW10 = V4L2_PIX_FMT_SBGGR10,
    OSPTEK_VIDEO_FMT_GREY = V4L2_PIX_FMT_GREY,
    OSPTEK_VIDEO_FMT_RGB565 = V4L2_PIX_FMT_RGB565,
    OSPTEK_VIDEO_FMT_RGB888 = V4L2_PIX_FMT_RGB24,
    OSPTEK_VIDEO_FMT_YUV422 = V4L2_PIX_FMT_YUV422P,
    OSPTEK_VIDEO_FMT_YUV420 = V4L2_PIX_FMT_YUV420,
} video_fmt_t;
...
/*
 * S65A:
 * Current ST7102/LVGL display path is marked as 24bpp/RGB888.
 * Force OSPTEK video helper to request RGB888 frames instead of RGB565,
 * otherwise RGB565 camera data is sent into a 24bpp panel path and may look greenish.
 */
...
#define OSPTEK_VIDEO_FMT              (OSPTEK_VIDEO_FMT_RGB565)
#elif CONFIG_LCD_PIXEL_FORMAT_RGB888
#define OSPTEK_VIDEO_FMT              (OSPTEK_VIDEO_FMT_RGB888)
#endif

typedef void (*osptek_video_frame_operation_cb_t)(uint8_t *camera_buf, uint8_t camera_buf_index, uint32_t camera_buf_hes, uint32_t camera_buf_ves, size_t camera_buf_len, void *user_data);
 ...
 * a LiteOS task to handle the streaming process.
 * Stops the video stream if task creation fails.
 *
 * @param video_fd File descriptor for the video device.
 * @param core_id Reserved compatibility parameter.
 * @return ESP_OK on success, or ESP_FAIL on failure.
 */
